SUMMARY = "Simple F4M/HDS (Adobe HTTP Dynamic Streaming) dumper. "
DESCRIPTION = "Simple F4M/HDS (Adobe HTTP Dynamic Streaming) dumper. "
...
SRC_URI = "git://github.com/jack2015/f4mdump.git;protocol=${GIT_PROTOCOL} \
