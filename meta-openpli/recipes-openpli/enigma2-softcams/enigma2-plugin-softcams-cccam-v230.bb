...
SUMMARY = "CCcam Softcam for DM800se Ver2.3.0"
...
do_install() {
	install -d ${D}/usr/bin
	install -m 0755 ${S}/CCcam ${D}/usr/bin/CCcam
	install -d ${D}/etc
	...
	install -m 0755 ${S}/softcam.CCcam230 ${D}/etc/init.d/softcam.CCcam230
}
