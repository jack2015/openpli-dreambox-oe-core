...
SUMMARY = "CCcam Softcam for DM800se Ver2.0.9"
...
do_install() {
	install -d ${D}/usr/bin
	install -m 0755 ${S}/CCcam209 ${D}/usr/bin/CCcam209
	install -d ${D}/etc
	...
	install -m 0755 ${S}/softcam.CCcam209 ${D}/etc/init.d/softcam.CCcam209
}
