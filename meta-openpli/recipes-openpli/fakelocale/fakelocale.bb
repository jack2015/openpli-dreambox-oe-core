...
SRC_URI = "git://gitlab.com/jack2015/fakelocale-locales.git;protocol=https;branch=master \
	file://locale.alias \
...
python populate_packages_prepend() {
    enigma2_localedir = bb.data.expand('${libdir}/locale', d)
    do_split_packages(d, enigma2_localedir, '^(\w+)/[a-zA-Z0-9_/]+.*$', 'enigma2-plugin-glibclocale-%s', '%s', recursive=True, match_path=True, prepend=True, extra_depends="fakelocale")
}
