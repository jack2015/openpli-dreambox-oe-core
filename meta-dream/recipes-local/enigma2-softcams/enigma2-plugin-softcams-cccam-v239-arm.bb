...
SUMMARY = "CCcam Softcam for DM900 & DM920 Ver2.3.9"
...
do_install() {
	install -d ${D}/usr/bin
	install -m 0755 ${S}/CCcam239 ${D}/usr/bin/CCcam239
	install -d ${D}/etc
	...
	install -m 0755 ${S}/softcam.CCcam239 ${D}/etc/init.d/softcam.CCcam239
}
